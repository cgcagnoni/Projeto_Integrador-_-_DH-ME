      ...
      <div class="row">
        ...
        <div class="col">
          <div class="adm-ong">
            ...
            <button class="button" type="button" v-on:click="alterarCadastroAdm">Alteração de cadastro</button>

            <button class="button" type="button" v-on:click="arrecadacao">Arrecadação</button>
          </div>
        </div>
      </div>
    </div>
